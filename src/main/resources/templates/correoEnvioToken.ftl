            ...
            <tr>
                ...
                <br>
                	<span style="font-family: Arial; text-align: justify">
	                    Sistema de Mesa de Partes Digital PENSIÓN65 - Validación de Correo electrónico:
	                    <br />
	                    <br />
	                     Estimado(a):
	                     <br />
	                    <br />
	                     El código de validación del correo electrónico es:
	                    <br />
	                    <div style="display:inline-block; padding:14px 25px; text-align:center; text-decoration:none; font-size: 16px; opacity:0.9; color:#FFFFFF; background-color:#f44336;" >${token}</div>
	                    <br />
	                    <br />
                    </span>
                </td>
