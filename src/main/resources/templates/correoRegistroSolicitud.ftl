        ...
        <tbody>
            <tr>
                ...
                <span style="font-family: Arial; text-align: justify">
                    Sistema de Mesa de Partes Digital PENSIÓN65 - Registro de Solicitud:
                    <br />
                    <br />
                     Estimado(a): ${nomusu}
                     <br />
                    <br />
                     Se ha realizado el registro de la solicitud, el número de registro de la solicitud es:
                    <br /><br />
                    <div style="display:inline-block; padding:14px 25px; text-align:center; text-decoration:none; font-size: 16px; opacity:0.9; color:#FFFFFF; background-color:#f44336;" >${numSolicitud}</div>
                    <br /><br />
                    La recepción del documento se realizará dentro de los horarios establecidos por la institución para la recepción de los documentos
                    <br /><br />
                    </span>
                </td>
            </tr>
