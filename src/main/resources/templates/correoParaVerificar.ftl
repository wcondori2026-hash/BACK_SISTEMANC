        ...
        <tbody>
            <tr>
                ...
                <span style="font-family: Arial; text-align: justify">
                    ...
                    <br />
                    <b>${correo.asunto}, ha sido registrada</b>
                    <br />
                   	<br />
                	...
                	<br /><br />
                    Puede seguir el estado de su trámite a través del siguiente enlace: http://cdt.pension65.gob.pe:8080/consulta/inicio.do
                	</span>
                </td>
            </tr>
            <tr>
